...
{
    public class Inventories2Controller : Controller
    {
        ...
        // GET: Inventories2/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Inventories2/Create
